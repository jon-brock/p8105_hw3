...
STEPS (NOT IN ORDER):
    Variables needed for this: product_name, order_dow, order_hour_of_day
    GROUP BY 'order_dow' for the days of week
    AS.FACTOR 'order_dow' / relevel the variable to be days of week
    FILTER == "Pink Lady Apples" and "Coffee Ice Cream"
    Calculate the mean value of 'hour_of"day'
    CREATE knitr::kable table
